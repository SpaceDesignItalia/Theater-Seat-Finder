...
export interface RowStepsProps extends React.HTMLAttributes<HTMLButtonElement> {
  ...
  /**
   * Whether steps can be clicked to change the current step.
   *
   * @default false
   */
              ...
              >
                <button
                  ...
                  className={cn(
                    ...
                    {
                      "cursor-pointer": allowStepClick,
                      "cursor-default": !allowStepClick,
                    },
                    stepClassName
                  )}
                  onClick={
                    allowStepClick ? () => setCurrentStep(stepIdx) : undefined
                  }
                  {...props}
                >
